...
static const _Reproducir_Request_type_support_symbol_names_t _Reproducir_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, srv, Reproducir_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces, srv, Reproducir_Request)),
  }
};
...
{
  return &::robot_interfaces::srv::rosidl_typesupport_cpp::Reproducir_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_interfaces, srv, Reproducir_Request)() {
  return get_message_type_support_handle<robot_interfaces::srv::Reproducir_Request>();
}
...
static const _Reproducir_Response_type_support_symbol_names_t _Reproducir_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, srv, Reproducir_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces, srv, Reproducir_Response)),
  }
};
...
{
  return &::robot_interfaces::srv::rosidl_typesupport_cpp::Reproducir_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_interfaces, srv, Reproducir_Response)() {
  return get_message_type_support_handle<robot_interfaces::srv::Reproducir_Response>();
}
...
static const _Reproducir_type_support_symbol_names_t _Reproducir_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, srv, Reproducir)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces, srv, Reproducir)),
  }
};
...
{
  return &::robot_interfaces::srv::rosidl_typesupport_cpp::Reproducir_service_type_support_handle;
}
